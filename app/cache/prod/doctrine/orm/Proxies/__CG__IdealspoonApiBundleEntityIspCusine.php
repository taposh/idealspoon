 ...
 */
class IspCusine extends \Idealspoon\ApiBundle\Entity\IspCusine implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setDscr($dscr);
    }

    public function getDscr()
    {
        $this->__load();
        return parent::getDscr();
    }
    ...
    {
        return array('__isInitialized__', 'name', 'dscr', 'id', 'restaurant');
    }
