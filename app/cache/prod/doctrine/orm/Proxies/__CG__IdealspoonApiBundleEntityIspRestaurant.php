 ...
 */
class IspRestaurant extends \Idealspoon\ApiBundle\Entity\IspRestaurant implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'name', 'id', 'cusine', 'address');
    }
