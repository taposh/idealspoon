...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/home/jason/projects/idealspoon/app/cache/dev/annotations', true);
    }
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('/home/jason/projects/idealspoon/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'IdealspoonFrontendBundle', '/home/jason/projects/idealspoon/app/Resources/IdealspoonFrontendBundle/views', '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'IdealspoonFrontendBundle', '/home/jason/projects/idealspoon/src/Idealspoon/FrontendBundle/Resources/views', '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, '', '/home/jason/projects/idealspoon/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, '/home/jason/projects/idealspoon/app/Resources');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'ispoondb', 'host' => '127.0.0.1', 'port' => NULL, 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driver' => 'pdo_mysql', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_0eb823c76db854d944db696f34c9af1b');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_0eb823c76db854d944db696f34c9af1b');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_0eb823c76db854d944db696f34c9af1b');

        $d = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array('/home/jason/projects/idealspoon/src/Idealspoon/ApiBundle/Resources/config/doctrine' => 'Idealspoon\\ApiBundle\\Entity', '/home/jason/projects/idealspoon/vendor/friendsofsymfony/user-bundle/FOS/UserBundle/Resources/config/doctrine' => 'FOS\\UserBundle\\Entity'));
        $d->setGlobalBasename('mapping');

        $e = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $e->addDriver($d, 'Idealspoon\\ApiBundle\\Entity');
        $e->addDriver($d, 'FOS\\UserBundle\\Entity');
        $e->addDriver(new \Doctrine\ORM\Mapping\Driver\XmlDriver(new \Doctrine\Common\Persistence\Mapping\Driver\SymfonyFileLocator(array('/home/jason/projects/idealspoon/vendor/friendsofsymfony/user-bundle/FOS/UserBundle/Resources/config/doctrine/model' => 'FOS\\UserBundle\\Model'), '.orm.xml')), 'FOS\\UserBundle\\Model');

        $f = new \Doctrine\ORM\Configuration();
        $f->setEntityNamespaces(array('IdealspoonApiBundle' => 'Idealspoon\\ApiBundle\\Entity', 'FOSUserBundle' => 'FOS\\UserBundle\\Entity'));
        $f->setMetadataCacheImpl($a);
        $f->setQueryCacheImpl($b);
        $f->setResultCacheImpl($c);
        $f->setMetadataDriverImpl($e);
        $f->setProxyDir('/home/jason/projects/idealspoon/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['escape_wsse_authentication.listener.wsse_secured'] = new \Escape\WSSEAuthenticationBundle\Security\Http\Firewall\Listener($this->get('security.context'), $this->get('security.authentication.manager'), $this->get('escape_wsse_authentication.entry_point.wsse_secured'));
    }
    ...
    {
        return $this->services['escape_wsse_authentication.provider'] = new \Escape\WSSEAuthenticationBundle\Security\Core\Authentication\Provider\Provider(NULL, '/home/jason/projects/idealspoon/app/cache/dev/security/nonces', 300);
    }
    ...
    {
        return $this->services['escape_wsse_authentication.provider.wsse_secured'] = new \Escape\WSSEAuthenticationBundle\Security\Core\Authentication\Provider\Provider($this->get('fos_user.user_provider.username'), NULL, 300);
    }
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), '/home/jason/projects/idealspoon/app/Resources');
    }
    ...
    {
        return $this->services['fos_rest.access_denied_listener'] = new \FOS\RestBundle\EventListener\AccessDeniedListener(array('json' => true), 'FOS\\RestBundle\\Controller\\ExceptionController::showAction', $this->get('monolog.logger.request', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['fos_rest.format_listener'] = new \FOS\RestBundle\EventListener\FormatListener($this->get('fos_rest.format_negotiator'), 'html', array(0 => 'html', 1 => '*/*'), false);
    }
    ...
    {
        return $this->services['fos_rest.mime_type_listener'] = new \FOS\RestBundle\EventListener\MimeTypeListener(array('json' => array(0 => 'application/json', 1 => 'application/x-json', 2 => 'application/vnd.example-com.foo+json'), 'rss' => 'application/rss+xml', 'jpg' => 'image/jpeg', 'png' => 'image/png', 'jsonp' => 'application/javascript'), $this->get('fos_rest.format_negotiator'));
    }
    ...
    {
        return $this->services['fos_rest.routing.loader.reader.action'] = new \FOS\RestBundle\Routing\Loader\Reader\RestActionReader($this->get('annotation_reader'), $this->get('fos_rest.request.param_fetcher.reader'), $this->get('fos_rest.inflector.doctrine'), true, array('jsonp' => false, 'json' => true, 'xml' => false));
    }
    ...
    {
        $this->services['fos_rest.view_handler'] = $instance = new \FOS\RestBundle\View\ViewHandler(array('jsonp' => false, 'json' => true, 'xml' => false), 400, 204, false, array('html' => 302), 'twig');

        $instance->setContainer($this);
        $instance->registerHandler('jsonp', array(0 => new \FOS\RestBundle\View\JsonpHandler('callback', '/(^[a-z0-9_]+$)|(^YUI\\.Env\\.JSONP\\._[0-9]+$)/i'), 1 => 'createResponse'));
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('Idealspoon\\ApiBundle\\Entity\\IspUser');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('Idealspoon\\ApiBundle\\Entity\\IspUser');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('Idealspoon\\ApiBundle\\Entity\\IspUser');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('Idealspoon\\ApiBundle\\Entity\\IspUser');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'Idealspoon\\ApiBundle\\Entity\\IspUser');
    }
    ...
    {
        return $this->services['jms_serializer.datetime_handler'] = new \JMS\Serializer\Handler\DateHandler('Y-m-d\\TH:i:sO', 'America/Toronto');
    }
    ...
    {
        $a = new \Metadata\Driver\FileLocator(array('Symfony\\Bundle\\FrameworkBundle' => '/home/jason/projects/idealspoon/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/config/serializer', 'Symfony\\Bundle\\SecurityBundle' => '/home/jason/projects/idealspoon/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/config/serializer', 'Symfony\\Bundle\\TwigBundle' => '/home/jason/projects/idealspoon/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/config/serializer', 'Symfony\\Bundle\\MonologBundle' => '/home/jason/projects/idealspoon/vendor/symfony/monolog-bundle/Symfony/Bundle/MonologBundle/Resources/config/serializer', 'Symfony\\Bundle\\SwiftmailerBundle' => '/home/jason/projects/idealspoon/vendor/symfony/swiftmailer-bundle/Symfony/Bundle/SwiftmailerBundle/Resources/config/serializer', 'Symfony\\Bundle\\AsseticBundle' => '/home/jason/projects/idealspoon/vendor/symfony/assetic-bundle/Symfony/Bundle/AsseticBundle/Resources/config/serializer', 'Doctrine\\Bundle\\DoctrineBundle' => '/home/jason/projects/idealspoon/vendor/doctrine/doctrine-bundle/Doctrine/Bundle/DoctrineBundle/Resources/config/serializer', 'Sensio\\Bundle\\FrameworkExtraBundle' => '/home/jason/projects/idealspoon/vendor/sensio/framework-extra-bundle/Sensio/Bundle/FrameworkExtraBundle/Resources/config/serializer', 'JMS\\SerializerBundle' => '/home/jason/projects/idealspoon/vendor/jms/serializer-bundle/JMS/SerializerBundle/Resources/config/serializer', 'FOS\\RestBundle' => '/home/jason/projects/idealspoon/vendor/friendsofsymfony/rest-bundle/FOS/RestBundle/Resources/config/serializer', 'Nelmio\\ApiDocBundle' => '/home/jason/projects/idealspoon/vendor/nelmio/api-doc-bundle/Nelmio/ApiDocBundle/Resources/config/serializer', 'Idealspoon\\ApiBundle' => '/home/jason/projects/idealspoon/src/Idealspoon/ApiBundle/Resources/config/serializer', 'FOS\\UserBundle' => '/home/jason/projects/idealspoon/vendor/friendsofsymfony/user-bundle/FOS/UserBundle/Resources/config/serializer', 'Escape\\WSSEAuthenticationBundle' => '/home/jason/projects/idealspoon/vendor/escapestudios/wsse-authentication-bundle/Escape/WSSEAuthenticationBundle/Resources/config/serializer', 'Idealspoon\\FrontendBundle' => '/home/jason/projects/idealspoon/src/Idealspoon/FrontendBundle/Resources/config/serializer', 'Acme\\DemoBundle' => '/home/jason/projects/idealspoon/src/Acme/DemoBundle/Resources/config/serializer', 'Symfony\\Bundle\\WebProfilerBundle' => '/home/jason/projects/idealspoon/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/config/serializer', 'Sensio\\Bundle\\DistributionBundle' => '/home/jason/projects/idealspoon/vendor/sensio/distribution-bundle/Sensio/Bundle/DistributionBundle/Resources/config/serializer', 'Sensio\\Bundle\\GeneratorBundle' => '/home/jason/projects/idealspoon/vendor/sensio/generator-bundle/Sensio/Bundle/GeneratorBundle/Resources/config/serializer'));
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('/home/jason/projects/idealspoon/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:/home/jason/projects/idealspoon/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, '/home/jason/projects/idealspoon/app/cache/dev/assetic/routing.yml', array('cache_dir' => '/home/jason/projects/idealspoon/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.wsse_secured' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/.*'), 'security.firewall.map.context.main' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/'))), $this->get('event_dispatcher'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_WsseSecuredService()
    {
        ...
        return $this->services['security.firewall.map.context.wsse_secured'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => $this->get('escape_wsse_authentication.listener.wsse_secured'), 2 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '522cc145baa3b', $b), 3 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $this->get('security.http_utils'), 'wsse_secured', $this->get('escape_wsse_authentication.entry_point.wsse_secured'), NULL, NULL, $b));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/home/jason/projects/idealspoon/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sensio_distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('/home/jason/projects/idealspoon/app');
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('/home/jason/projects/idealspoon/app/cache/dev/sessions');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/home/jason/projects/idealspoon/app/cache/dev/sessions');
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, '/home/jason/projects/idealspoon/app', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini')), array('cache_dir' => '/home/jason/projects/idealspoon/app/cache/dev/translations', 'debug' => true));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('exception_controller' => 'FOS\\RestBundle\\Controller\\ExceptionController::showAction', 'debug' => true, 'strict_variables' => true, 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => '/home/jason/projects/idealspoon/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, '/home/jason/projects/idealspoon/app', 'UTF-8'));
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), true, array(), array(0 => 'IdealspoonFrontendBundle'), $this->get('assetic.value_supplier.default', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/home/jason/projects/idealspoon/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('/home/jason/projects/idealspoon/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/views', 'Security');
        $instance->addPath('/home/jason/projects/idealspoon/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/views', 'Twig');
        $instance->addPath('/home/jason/projects/idealspoon/vendor/symfony/swiftmailer-bundle/Symfony/Bundle/SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('/home/jason/projects/idealspoon/vendor/doctrine/doctrine-bundle/Doctrine/Bundle/DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('/home/jason/projects/idealspoon/vendor/nelmio/api-doc-bundle/Nelmio/ApiDocBundle/Resources/views', 'NelmioApiDoc');
        $instance->addPath('/home/jason/projects/idealspoon/src/Idealspoon/ApiBundle/Resources/views', 'IdealspoonApi');
        $instance->addPath('/home/jason/projects/idealspoon/vendor/friendsofsymfony/user-bundle/FOS/UserBundle/Resources/views', 'FOSUser');
        $instance->addPath('/home/jason/projects/idealspoon/src/Idealspoon/FrontendBundle/Resources/views', 'IdealspoonFrontend');
        $instance->addPath('/home/jason/projects/idealspoon/src/Acme/DemoBundle/Resources/views', 'AcmeDemo');
        $instance->addPath('/home/jason/projects/idealspoon/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('/home/jason/projects/idealspoon/vendor/sensio/distribution-bundle/Sensio/Bundle/DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('/home/jason/projects/idealspoon/app/Resources/views');
        $instance->addPath('/home/jason/projects/idealspoon/vendor/symfony/symfony/src/Symfony/Bridge/Twig/Resources/views/Form');
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/home/jason/projects/idealspoon/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('/home/jason/projects/idealspoon/app/cache/dev/assetic/assets');
    }
    ...
    protected function getJmsSerializer_MetadataFactoryService()
    {
        ...
        $instance->setCache(new \Metadata\Cache\FileCache('/home/jason/projects/idealspoon/app/cache/dev/jms_serializer'));
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/home/jason/projects/idealspoon/app/cache/dev');
    }
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader($this->get('annotation_reader')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader(), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => '/home/jason/projects/idealspoon/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml', 1 => '/home/jason/projects/idealspoon/vendor/friendsofsymfony/user-bundle/FOS/UserBundle/Resources/config/validation.xml', 2 => '/home/jason/projects/idealspoon/vendor/friendsofsymfony/user-bundle/FOS/UserBundle/Resources/config/validation/orm.xml')), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array()))), NULL);
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/home/jason/projects/idealspoon/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/home/jason/projects/idealspoon/app/cache/dev',
            'kernel.logs_dir' => '/home/jason/projects/idealspoon/app/logs',
            'kernel.bundles' => array(
                ...
                'IdealspoonApiBundle' => 'Idealspoon\\ApiBundle\\IdealspoonApiBundle',
                'FOSUserBundle' => 'FOS\\UserBundle\\FOSUserBundle',
                'EscapeWSSEAuthenticationBundle' => 'Escape\\WSSEAuthenticationBundle\\EscapeWSSEAuthenticationBundle',
                'IdealspoonFrontendBundle' => 'Idealspoon\\FrontendBundle\\IdealspoonFrontendBundle',
            ...
            'debug.container.dump' => '/home/jason/projects/idealspoon/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'session.save_path' => '/home/jason/projects/idealspoon/app/cache/dev/sessions',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => '/home/jason/projects/idealspoon/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml',
                1 => '/home/jason/projects/idealspoon/vendor/friendsofsymfony/user-bundle/FOS/UserBundle/Resources/config/validation.xml',
                2 => '/home/jason/projects/idealspoon/vendor/friendsofsymfony/user-bundle/FOS/UserBundle/Resources/config/validation/orm.xml',
            ),
            ...
            'profiler.storage.dsn' => 'file:/home/jason/projects/idealspoon/app/cache/dev/profiler',
            ...
            'router.resource' => '/home/jason/projects/idealspoon/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/home/jason/projects/idealspoon/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => '/home/jason/projects/idealspoon/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => '/home/jason/projects/idealspoon/app/cache/dev/assetic',
            'assetic.bundles' => array(
                0 => 'IdealspoonFrontendBundle',
            ),
            ...
            'assetic.read_from' => '/home/jason/projects/idealspoon/app/../web',
            'assetic.write_to' => '/home/jason/projects/idealspoon/app/../web',
            ...
            'doctrine.orm.proxy_dir' => '/home/jason/projects/idealspoon/app/cache/dev/doctrine/orm/Proxies',
            ...
            'fos_rest.cache_dir' => '/home/jason/projects/idealspoon/app/cache/dev/fos_rest',
            ...
            'fos_rest.prefer_extension' => false,
            ...
            'fos_user.model.user.class' => 'Idealspoon\\ApiBundle\\Entity\\IspUser',
